const contractAddress = "0xF80677dF2bA53f885604A8Fbe2BbAb450deba968"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Irky Kid NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Irky Kid NFT Project is a decentralized NFT collection based on the Polygon Network';
